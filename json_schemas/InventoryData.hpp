...
enum class Name : int { INSPECT_IN_GAME,
                        ITEM_WIKI_PAGE };
...
enum class BackgroundColor : int { THE_3_C352_E };
...
enum class InternalName : int {
    ...
    CAMPAIGN3_PAINTKITS_CASE2_COLLECTION,
    ...
    WINTER2017_PAINTKITS_COLLECTION,
...
struct Inventory {
    ...
    std::shared_ptr<std::vector<InventoryDescription>> descriptions;
...
inline void from_json(const json& j, JsonInventory::Inventory& x) {
    x.assets = JsonInventory::get_optional<std::vector<JsonInventory::Asset>>(j, "assets");
    x.descriptions = JsonInventory::get_optional<std::vector<JsonInventory::InventoryDescription>>(j, "descriptions");
...
inline void from_json(const json& j, JsonInventory::Color& x) {
    static std::unordered_map<std::string, JsonInventory::Color> enumValues{
        ...
        {"8650AC", JsonInventory::Color::THE_8650_AC},
...
inline void to_json(json& j, const JsonInventory::Color& x) {
    switch (x) {
        ...
        case JsonInventory::Color::THE_7_EA9_D1:
            j = "7ea9d1";
            break;
        case JsonInventory::Color::THE_8650_AC:
            j = "8650AC";
            break;
...
inline void from_json(const json& j, JsonInventory::InternalName& x) {
    static std::unordered_map<std::string, JsonInventory::InternalName> enumValues{
        ...
        {"Campaign3Paintkits_case2_collection", JsonInventory::InternalName::CAMPAIGN3_PAINTKITS_CASE2_COLLECTION},
        ...
        {"TF_KillStreakifierToolB", JsonInventory::InternalName::TF_KILL_STREAKIFIER_TOOL_B},
        ...
        {"TF_StrangePartRestriction", JsonInventory::InternalName::TF_STRANGE_PART_RESTRICTION},
        ...
        {"tough_break_case_collection_02", JsonInventory::InternalName::TOUGH_BREAK_CASE_COLLECTION_02},
        ...
        {"Winter2017Paintkits_collection", JsonInventory::InternalName::WINTER2017_PAINTKITS_COLLECTION},
...
inline void to_json(json& j, const JsonInventory::InternalName& x) {
    switch (x) {
        ...
        case JsonInventory::InternalName::CAMPAIGN3_PAINTKITS_CASE1_COLLECTION:
            ...
            break;
        case JsonInventory::InternalName::CAMPAIGN3_PAINTKITS_CASE2_COLLECTION:
            j = "Campaign3Paintkits_case2_collection";
            break;
        ...
        case JsonInventory::InternalName::TF_KILL_STREAKIFIER_TOOL_A:
            ...
            break;
        case JsonInventory::InternalName::TF_KILL_STREAKIFIER_TOOL_B:
            j = "TF_KillStreakifierToolB";
            break;
        ...
        case JsonInventory::InternalName::TF_STRANGE_PART:
            j = "TF_StrangePart";
            break;
        case JsonInventory::InternalName::TF_STRANGE_PART_RESTRICTION:
            j = "TF_StrangePartRestriction";
            break;
        ...
        case JsonInventory::InternalName::TOUGH_BREAK_CASE_COLLECTION_01:
            ...
            break;
        case JsonInventory::InternalName::TOUGH_BREAK_CASE_COLLECTION_02:
            j = "tough_break_case_collection_02";
            break;
        ...
        case JsonInventory::InternalName::WINTER2017_COSMETICS_COLLECTION:
            ...
            break;
        case JsonInventory::InternalName::WINTER2017_PAINTKITS_COLLECTION:
            j = "Winter2017Paintkits_collection";
            break;
...
inline void from_json(const json& j, JsonInventory::LocalizedTagName& x) {
    static std::unordered_map<std::string, JsonInventory::LocalizedTagName> enumValues{
        ...
        {"Infernal Reward Collection", JsonInventory::LocalizedTagName::INFERNAL_REWARD_COLLECTION},
        ...
        {"Specialized Killstreak Kit", JsonInventory::LocalizedTagName::SPECIALIZED_KILLSTREAK_KIT},
        ...
        {"Strange Filter", JsonInventory::LocalizedTagName::STRANGE_FILTER},
        ...
        {"Warbird Collection", JsonInventory::LocalizedTagName::WARBIRD_COLLECTION},
        ...
        {"Winter 2017 Collection", JsonInventory::LocalizedTagName::WINTER_2017_COLLECTION},
...
inline void to_json(json& j, const JsonInventory::LocalizedTagName& x) {
    switch (x) {
        ...
        case JsonInventory::LocalizedTagName::HEAVY:
            j = "Heavy";
            break;
        case JsonInventory::LocalizedTagName::INFERNAL_REWARD_COLLECTION:
            j = "Infernal Reward Collection";
            break;
        ...
        case JsonInventory::LocalizedTagName::SOLDIER:
            j = "Soldier";
            break;
        case JsonInventory::LocalizedTagName::SPECIALIZED_KILLSTREAK_KIT:
            j = "Specialized Killstreak Kit";
            break;
        ...
        case JsonInventory::LocalizedTagName::STRANGE:
            j = "Strange";
            break;
        case JsonInventory::LocalizedTagName::STRANGE_FILTER:
            j = "Strange Filter";
            break;
        ...
        case JsonInventory::LocalizedTagName::VIOLET_VERMIN_COLLECTION:
            ...
            break;
        case JsonInventory::LocalizedTagName::WARBIRD_COLLECTION:
            j = "Warbird Collection";
            break;
        ...
        case JsonInventory::LocalizedTagName::WINTER_2016_COSMETICS_COLLECTION:
            ...
            break;
        case JsonInventory::LocalizedTagName::WINTER_2017_COLLECTION:
            j = "Winter 2017 Collection";
            break;
